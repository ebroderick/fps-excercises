...
object Exercise0313 {
  ...
  //From https://github.com/fpinscala/fpinscala/blob/master/answerkey/datastructures/13.answer.scala
  ...
  def foldLeftViaFoldRight_1[A,B](as: List[A], outerIdent: B)(combiner: (B, A) => B): B = {
    ...
    def go:BtoB = List.foldRight(as, innerIdent)(combinerDelayer)
